...
# from langchain.vector_stores import ElasticsearchStore
...
#     fetch_random_articles_by_source(vector_store, "MIT News Office")
#     get_articles_by_author(vector_store, "Adam Zewe")
#     get_articles_after_date(vector_store, "2020-07-10")
#     search_articles_by_keyword(vector_store, "AI")
#     search_articles_by_heading(vector_store, "molecules")
