...
def chat():
    with st.sidebar:
        # if not "chatbot_api_key" in st.session_state or not st.session_state["chatbot_api_key"]:
        #     openai_api_key = st.text_input("OpenAI API Key", key="chatbot_api_key", type="password")
    
        # os.environ["OPENAI_API_KEY"] = st.session_state["chatbot_api_key"]
        
        # if not "elastic_database_id" in st.session_state or not st.session_state["elastic_database_id"]:
        #     elastic_database_id = st.text_input("Elastic Cloud ID", key="elastic_database_id", type="password")
            
        # if not "elastic_api_key" in st.session_state or not st.session_state["elastic_api_key"]:
        #     elastic_api_key = st.text_input("Elastic API key", key="elastic_api_key", type="password")
